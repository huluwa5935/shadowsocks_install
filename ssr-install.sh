...
#安装chacha20的依赖库
wget -N --no-check-certificate https://raw.githubusercontent.com/huluwa5935/shadowsocks_install/master/libsodium-1.0.12.tar.gz
...
#下载定制脚本到目录
if ! wget --no-check-certificate https://raw.githubusercontent.com/huluwa5935/shadowsocks_install/master/ssr.sh -O ${ssrdir}ssr.sh; then
